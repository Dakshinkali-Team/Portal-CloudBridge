        ...
        <div className="flex flex-col lg:flex-row items-start gap-12">
          ...
          <div className="max-w-xl">
            ...
            <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 max-w-xl leading-tight mb-6">
              ...
              <span className="text-[#0B78C1]">Adoption.</span>
            </h1>

            {/* DESCRIPTION */}
            <p className="text-lg text-[#414651] max-w-sm mb-8">
              The enterprise-grade portal for seamless quote-to-provision
              workflows. Get full control, transparency, and security for your
