...
// ── Static data (replace with API call / React Query in production) ──────────
...
const INITIAL_SERVICES = [
  ...
  },
  {
    ...
    category: "Database",
    specs: "Standard, 20GB Storage",
    price: 80,
    status: "active",
  },
  {
    id: 3,
    name: "Block Storage - 100GB",
    category: "Storage",
    specs: "SSD, 100GB",
    price: 10,
    status: "active",
...
export default function AdminServiceConfig() {
  ...
  return (
    <div className="bg-[#F8FAFC] min-h-screen">
      ...
      >
      <Button variant="primary" className="shadow-lg shadow-blue-400/40 text-sm">
        <PlusIcon />
          Add Service
      </Button>
      </PageHeader>
          ...
          <tr key={svc.id} className="hover:bg-slate-50/70 transition-colors">
            ...
            <td className="px-5 py-4">
              <div className="flex items-center justify-end gap-1.5">
                ...
                <IconButton title="Edit service" variant="default">
                  <EditIcon />
                </IconButton>
