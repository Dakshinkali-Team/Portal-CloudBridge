 ...
 * Must be consistent with frontend validation
 */
 ...
 * @param {object} data - { name: string, email: string, password: string, companyName?: string, accountType?: string }
...
export const validateRegistrationData = (data) => {
  ...
  const normalizedAccountType =
    data.accountType && String(data.accountType).trim().toUpperCase() === "COMPANY"
      ? "COMPANY"
      : "INDIVIDUAL";
